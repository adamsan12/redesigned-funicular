...
function toggleReadMore(){var wrapper=document.getElementById('readMoreWrapper');var btn=document.getElementById('toggleReadMoreBtn');if(wrapper.classList.contains('expanded')){wrapper.classList.remove('expanded');btn.textContent='Selengkapnya...'}else{wrapper.classList.add('expanded');btn.textContent='Sembunyikan'}}
